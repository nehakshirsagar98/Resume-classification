 ...
 * Generated at: 2020-05-13 10:12:54 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Search Jobs here\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"searchJob\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-sm btn-info btn-round\" disabled>Applied</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");

															} else {
														
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-sm btn-success btn-round\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"applyJob('");
      out.print(jm.getJid() );
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\t  function applyJob(jid) {\r\n");
      out.write("\t\t  $.post(\"");
      out.print(request.getContextPath());
      out.write("/tiles/ajax.jsp?methodId=applyJob&uid=");
      out.print(userId);
      out.write("&jid=\"+jid\r\n");
      out.write("\t, \"\", function(data) {\r\n");
      out.write("\t\t\t\t\t\t\tdata = $.trim(data);\r\n");
      out.write("\t\t\t\t\t\t\talert(\"Information :\" + data);\r\n");
      ...
      out.write("\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t$(\"#searchJob\").on(\r\n");
      out.write("\t\t\t\t\t\t\"keyup\",\r\n");
      out.write("\t\t\t\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t\t\t\tvar value = $(this).val().toLowerCase();\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#jobs tr\").filter(\r\n");
      out.write("\t\t\t\t\t\t\t\t\tfunction() {\r\n");
