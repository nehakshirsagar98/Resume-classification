 ...
 * Generated at: 2020-05-13 10:13:06 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 class=\"page-title\">Resume</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-title\">Resume Details</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Degree</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Experience</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">No. Of Project</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Designation</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Percentage </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Current CTC</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Expected CTC</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th scope=\"col\">Prefered Location</th>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getDegree());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getExperience());
      out.write("</td>\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getProjectscount());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getDesignation());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getPercentage());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getCurrentctc());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getExpectedctc());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(sm.getPreferedlocations());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><button class=\"btn btn-info\" onclick=\"\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/tiles/ajax.jsp?methodId=viewFile&uid=");
      out.print(uId);
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t target=\"_blank\" type=\"application/pdf\">\r\n");
      out.write("                                      <i class=\"la la-cloud-download\"></i>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#exampleModal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t <img data-toggle=\"tooltip\" title=\"Displaying Pi chart For Uploaded Resume\" class=\"rounded-circle mx-auto d-block\" height=\"auto\" width=\"50%\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t src=\"");
      out.print(request.getContextPath());
      out.write("/tiles/ajax.jsp?methodId=showImage&pid=");
      out.print(um.getUid());
      out.write("\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t alt=\"Resultant Pi Chart image Displayed Here\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
