...
<body style="background-color: #0261b0">
	...
	<div class="" align="center"
		...
		<h1 style="color: white; font-family: arial;">Resume Classification Portal</h1>
		<div class="col-md-4">
			<div class="card">
				<div class="card-header">
					<div class="card-title">Recruiter Registration</div>
				</div>
				<div class="card-body">
					<form method="post" 
						action="javascript:fnReg();" name="regform" id="regform">
						
						<div class="form-group has-success" align="left">
							<label for="successInput">First Name</label><br> <br>
							<input type="text" id="fname" name="fname"
								placeholder="First Name" class="form-control" required="required">
						</div>
						<div class="form-group has-success" align="left">
							<label for="successInput">Last Name</label><br> <br>
						...
						<div class="form-group has-success" align="left">
							...
							<input type="text" id="phone" name="phone"
								placeholder="Mobile Number" class="form-control" attern="[0-9]{10}"
					title="Accepted 10 Digit Only" required="required">
						...
						<div class="form-group has-success" align="left">
							<label for="successInput">Password</label><br> <br>
						...
						<div class="form-group has-success" align="left">
							<label for="successInput">Company Name</label><br> <br>
							<input type="text" id="cname" name="cname"
								placeholder="Company" class="form-control" required="required">
						</div>						
...
// 	alert(str);
	$.post("<%=request.getContextPath()%>/tiles/ajax.jsp?methodId=registerNewRecruiter",
						str, function(data) {
							data = $.trim(data);
							if (data==1) {
