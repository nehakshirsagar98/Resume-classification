													...
													<br>
														...
														<div class="col-md-6">
															...
															<input type="checkbox" name="s" id="s"
																value="Stats," onclick="add_sub(this);"><label
																for="bob">Data Science</label><br> <input
																...
																value="DataEngineering," onclick="add_sub(this);"><label
																for="bob2">Data Engineering</label><br> 
															<input
																type="checkbox" name="s5" id="s5" value="Python"
																onclick="add_sub(this);"><label for="bob2">
																Python</label>
														</div>
														<div class="col-md-6">
															<input type="checkbox" name="s3" id="s3" value="NLP,"
																onclick="add_sub(this);"><label for="bob">NLP</label><br>
															<input type="checkbox" name="s3" id="s3" value="R,"
																onclick="add_sub(this);"><label for="bob">R Language</label><br>
															<input type="checkbox" name="s4" id="s4"
																value="DL," onclick="add_sub(this);"><label
																for="bob1">Deep Learning</label>
														</div>
													</div>
													<br>
